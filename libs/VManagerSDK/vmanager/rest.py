...
class RESTResponse(io.IOBase):
    ...
    def getstream(self):
        ...
        """
        # TODO: check for chunked encoding header
        return self.urllib3_response.stream()
...
class RESTClientObject(object):
    ...
    def request(self, method, url, query_params=None, headers=None,
                body=None, post_params=None, stream=False):
        """
        ...
        try:
            ...
            # For `GET`, `HEAD`, `DELETE`
                ...
                urllib3_params = {}
                if stream:
                    # when streaming, we don't want to fetch the whole page
                    urllib3_params['preload_content'] = False
                r = self.pool_manager.request(method, url,
                                              fields=query_params,
                                              headers=headers,
                                              **urllib3_params)
