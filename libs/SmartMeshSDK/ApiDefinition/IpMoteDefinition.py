...
class IpMoteDefinition(ApiDefinition.ApiDefinition):
    ...
    subCommandsSet = [
        ...
        },
        {
            ...
            'description': 'The setParameter<euCompliantMode> commandmay be used to set the EN 300 328 compliance mode that is used by the device. When enabled, the mote may skip some transmit opportunities to remain within average power limits. Motes below +10 dBm radiated power do not need to duty cycle to meet EN 300 328 requirements.\n\nNote: This parameter is available indevices running mote software>=1.4.x',
            'request'    : [
    ...
    subCommandsGet = [
        ...
        },
        {
            'id'         : 0x2a,
            'name'       : 'euCompliantMode',
            'description': 'The getParameter<euCompliantMode> commandmay be used to retrieve the EN 300 328 compliance mode that is used by the device. When enabled, the mote may skip some transmit opportunities to remain within average power limits. Motes below +10 dBm radiated power do not need to duty cycle to meet EN 300 328 requirements.\n\nNote: This parameter is available indevices running mote software>=1.4.x',
            'request'    : [
            ],
            'response'   : {
                'FIELDS':  [
    ...
    commands = [
        ...
        },
        {
            'id'         : 0x2B,
            'name'       : 'socketInfo',
            'description': 'Retrieve information about a socket. (Available in IP Mote >= 1.4.0)',
            'request'    : [
                ['index',                   INT,      1,   None],
            ],
            'response'   : {
